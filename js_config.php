...
PM.buttonsDefault = {
    ...
    buttons: [
		...
		{tool:'Cho_Thue',        name:'Cho_Thue'},
		{tool:'Tim_nha',        name:'Tim_nha'},
		//{tool:'Kiem_duyet',        name:'Kiem_duyet'},
		{tool:'Phan_hoi',        name:'Phan_hoi'},
		{tool:'dangky',        name:'dangky'},
        {tool:'giaodich',        name:'giaodich'}
    ]
};
...
PM.linksDefault = {
    ...
    links: [
       // {linkid:'Đăng nhập', name:'Đăng nhập', run:'http://localhost/nhatro/plugins/pmauth/auth.phtml', imgsrc:'print-w.png'},
        {linkid:'download', name:'Tải về', run:'PM.Dlg.openDownload', imgsrc:'download-w.png'},
        {linkid:'help', name:'Giúp đỡ', run:'PM.Dlg.openHelp', imgsrc:'help-w.png'},
        {linkid:'home', name:'Trang chủ', run:'http://www.pmapper.net', target:'_new', imgsrc:'home-w.png'},
        {linkid:'Rate', name:'Đánh giá Website', run:'PM.Plugin.Rate.openRateDlg', imgsrc:'home-w.png'}
